...
# Galaxy note 8.0
PRODUCT[0]="n5100"                        # phone model name (product folder name)
LUNCHCMD[0]="n5100"                       # lunch command used for ROM
...
# nexus 5
# PRODUCT[5]="hammerhead"
# LUNCHCMD[5]="hammerhead"
